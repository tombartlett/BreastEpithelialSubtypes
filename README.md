...
Estimates breast tissue cell-type proportions from DNA methylation microarry data, including the breast epithelium cell-subtypes luminal progenitor, mature luminal, and basal, based on reference profiles <strong>A</strong>∈R^<sup>p×k}</sup> derived from Pellicani et al (2016), defined for <em>p</em> genes on <em>k</em> cell-types.
